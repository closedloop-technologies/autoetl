...
#   filename:  openapi_spec_30.json
#   timestamp: 2024-03-21T01:11:55+00:00
...
class ParameterLocation1(BaseModel):
...
class ParameterLocation2(BaseModel):
...
class ParameterLocation3(BaseModel):
...
class ParameterLocation4(BaseModel):
...
class ParameterLocation(BaseModel):
    __root__: Union[
        ParameterLocation1, ParameterLocation2, ParameterLocation3, ParameterLocation4
...
class HTTPSecurityScheme1(BaseModel):
    ...
    scheme: constr(regex=r'^[Bb][Ee][Aa][Rr][Ee][Rr]$')
